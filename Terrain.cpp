 ...
 *      Author: Meet Pandya 1214306
 *     		    Sahajmeet Bhutta 1223708
 *
 *      Assistance for the snowman was provided by the snowman code from Dr. Teather
 *      Assistance for the lighting was supported by the Teapot code from Dr. Teather
 *      Assistance for the light colors was provided by:(LIME GREEN)
 *      		https://www.opengl.org/discussion_boards/showthread.php/132502-Color-tables
 *      Assistance for the calculation of the cross product was given by:
 *      		http://www.mathsisfun.com/algebra/vectors-cross-product.html
 *      Assistance for the multi-window aspect was provided by:
 *      		http://deslab.mit.edu/DesignLab/courses/13.016/graphics/multi.html
 *      Assistance for the fault and the circle algorithm was provided by:
...
//THIS FUNCTION IMPLEMENTS THE FAULT ALGORITHM; PSEUDOCODE REFERENCED AS GIVEN IN THE ASSIGNMENT OUTLINE
void CreateTerrain() {
	for (int z = 0; z < terrainArea + 1; z++) {
		for (int x = 0; x < terrainArea + 1; x++) {
			float k = rand() % 100 + 1;
...
//THIS FUNCTION IMPLEMENTS THE CIRCLE ALGORITHM; PSEUDOCODE REFERENCED AS GIVEN IN THE ASSIGNMENT OUTLINE
...
//THIS FUNCTION CALCULATES FACE NORMALS PSEUDOCODE REFERENCED AS GIVEN IN THE ASSIGNMENT OUTLINE
...
//THIS FUNCTION DRAWS THE SNOWMAN, THE MOVABLE CHARACTER IMPLEMENTED AS AN EXTRA FEATURE CODE REFERENCED FROM SAMPLE CODE GIVEN BY DR. TEATHER
...
//DISPLAY FUNCTION FOR THE SECOND WINDOW CALLS twoDrep
...
int main(int argc, char** argv) {
	...
	printf("----------------------------------------------------\n");
	printf("----------------------------------------------------\n");
	printf("Sahajmeet Bhutta, 1223708. November 28th 2014\n");
	printf("Meet Pandya, 1214306\n");
	printf("----------------------------------------------------\n");
	printf("----------------------------------------------------\n");
	printf("--------------------Instructions--------------------\n");
	printf("----------------------------------------------------\n");
	...
	printf(
			"Number 1 key - Switch between fault algorithm and circle algorithm\n");
	printf("----------------------------------------------------\n");
	printf("----------------------------------------------------\n");
	printf("---------------------Thank you!---------------------\n");
	printf("----------------------------------------------------\n");
